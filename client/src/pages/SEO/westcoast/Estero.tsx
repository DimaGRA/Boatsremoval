...
export default function Estero() {
  const [, setLocation] = useLocation();
   const nearbyCities = getNearbyCities("Estero", 60); // find up to 60 closest
  const phone = getPhoneByCity("Estero");
  ...
  const faqs = [
    {
      question: "How quickly can you remove a boat in Estero?",
      answer: "We offer same-day and next-day boat removal services in Estero, FL. Contact us before noon for potential same-day service. Emergency removals available 24/7."
    },
    {
    ...
    },
    {
      ...
      answer: "Yes! We remove boats from residential driveways, backyards, marinas, storage facilities, and waterfront properties throughout Estero. We handle all permits and logistics."
    },
    {
      question: "Is boat removal in Estero expensive?",
      answer: "Our Estero boat removal services are budget-friendly and transparent. Costs vary by boat size, condition, and access. We offer free quotes and specialize only in removal and disposal — not boat purchases."
    }
  ];
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <Helmet>
        <title>Boat Removal Estero FL | Professional Disposal & Dismantling Services</title>
        <meta name="description" content="Expert boat removal services in Estero, Florida. Free quotes, same-day service, eco-friendly disposal. Serving nearby areas for boats, yachts & catamarans of all sizes." />
        <meta property="og:title" content="Boat Removal Estero FL | Professional Services" />
        <meta 
          property="og:description" 
          content="Expert boat removal services in Estero, Florida. Free quotes, same-day service, eco-friendly disposal." 
        />
        <meta property="og:type" content="website" />
        <link rel="canonical" href="https://www.boatsremoval.com/boat-removal-fl-estero" />
      </Helmet>
     <Header cityName="Estero" />
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl">
              <div className="flex items-center gap-2 mb-4">
                ...
                <span className="text-sm font-semibold text-muted-foreground">Estero, Florida</span>
              </div>
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-foreground mb-6" data-testid="text-heading-main">
                Professional Boat Removal Services in Estero, FL
              </h1>
              <p className="text-xl text-muted-foreground mb-8">
                Expert boat disposal and dismantling services for Estero residents and businesses. 
    ...
    <RandomBoatGallery cityName="Estero" count={2} />
        {/* Why Choose Us Section */}
        <section className="py-16 md:py-20 bg-muted">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">
                Why Choose <span className="text-primary">Florida Boat Removal</span> in Estero?
              </h2>
              <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
                We're the trusted boat removal experts serving Estero and all of Lee County
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <Card>
                ...
                <CardContent>
                  <p className="text-muted-foreground">
                    Based in Florida, we understand Estero's unique coastal environment and local regulations.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent>
                  <p className="text-muted-foreground">
                    Fast response times with same-day removal available for urgent situations in Estero.
                  </p>
                </CardContent>
              </Card>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-lg text-muted-foreground mb-6">
                  ...
                  or a derelict boat that needs immediate removal, we provide complete solutions for Estero residents.
                </p>
              ...
              <Card>
                <CardHeader>
                  <CardTitle>Areas We Serve in Estero</CardTitle>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-muted-foreground">
                Fast and hassle-free boat removal in Estero
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <Card>
                ...
                <CardContent>
                  <p className="text-muted-foreground">
                    Call us or fill out our online form with details about your boat and location in Estero. 
        ...
        <section className="py-16 md:py-20">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-muted-foreground">
                Common questions about boat removal in Estero
              </p>
            </div>
...
<section className="py-16 md:py-20 bg-muted text-center">
  <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <p className="text-lg text-muted-foreground mb-8">
      ...
      to speak with our boat removal specialist serving Estero and all of Lee County.
    ...
    >
      ...
      <ArrowRight className="ml-2 h-5 w-5" />
        ...
        <section className="py-16 md:py-20 bg-muted">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-6">
              About <span className="text-primary">Florida Boat Removal</span> in Estero, Florida
            </h2>
