export default function WhatWeDo() {
  return (
    <section id="what-we-do" className="py-16 md:py-20 bg-background">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          >
            Fast & Reliable Boat Removal and Disposal Across Florida
          </h2>

          <div
            className="text-lg text-muted-foreground max-w-3xl mx-auto space-y-5"
            data-testid="text-services-subtitle"
          >
            <p>
              Florida Boat Removal is a <strong>local, family-run company</strong>
              providing professional boat removal services since <strong>1997</strong>.
              We make removing unwanted boats simple, safe, and stress-free.
            </p>

            <p>
              Boats on land, in the water, or even submerged — we handle the entire process
