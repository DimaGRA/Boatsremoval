...
export default function Header({ onLanguageChange, currentLanguage = "en" }: HeaderProps) {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 bg-primary z-50 border-b border-primary-border">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <div className="flex items-center gap-3">
            <a href="tel:+18005551234" className="hidden sm:flex items-center gap-2 text-primary-foreground" data-testid="link-phone">
        ...
        {mobileMenuOpen && (
          <div className="md:hidden py-4 border-t border-primary-border">
            <nav className="flex flex-col gap-3">
              ...
              <a href="tel:+18005551234" className="flex items-center gap-2 text-primary-foreground font-bold py-2 sm:hidden" data-testid="mobile-link-phone">
                <Phone className="h-5 w-5" />
                1-800-555-1234
              </a>
            </nav>
